...
def page_leaf_visualizer_body():
    ...
    st.info(
        ...
        f"differentiates a powdery mildew from an healthy leaf.")
    
    version = 'v2'
    if st.checkbox("Difference between average and variability image"):
      
      avg_powdery_mildew = plt.imread(f"outputs/avg_var_powdery_mildew.png")
      avg_healthy = plt.imread(f"outputs/avg_var_healthy.png")
    ...
    if st.checkbox("Differences between average powdery mildew and average healthy leaf"):
          diff_between_avgs = plt.imread(f"outputs/avg_diff_healthy_powdery_mildew.png")
